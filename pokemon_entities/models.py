...
class Pokemon(models.Model):
    ...
    title_en  = models.CharField(max_length=255, null=True, verbose_name='Имя покемона на английском')
    title_jp = models.CharField(max_length=255, null=True, verbose_name='Имя покемона на японском')
